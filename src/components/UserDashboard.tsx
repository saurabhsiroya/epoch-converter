...
const UserDashboard: React.FC<UserDashboardProps> = ({ isOpen, onClose }) => {
  ...
  const regenerateApiKey = () => {
    ...
    // In a real app, this would update the user's API key in the database
          ...
          <div className="w-64 bg-gray-50 dark:bg-gray-900 p-6">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 capitalize">{user.plan} Plan</p>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                    ...
                    <p className="text-2xl font-bold text-blue-600 dark:text-blue-400 capitalize">{user.plan}</p>
                  </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                  ...
                  <div className="mb-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-gray-900 dark:text-white">
                        {user.usage.current} / {user.usage.limit.toLocaleString()}
                      </span>
                    </div>
                  </div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                    Resets on {new Date(user.usage.resetDate).toLocaleDateString()}
                  </p>
                </div>
              </div>
            )}
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      ...
                      className="flex items-center px-3 py-1 text-sm bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
                    >
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                    ...
                    <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">
                      {(user.usage.limit - user.usage.current).toLocaleString()}
                    </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    {[
                      { date: 'Today', requests: 45, percentage: 15 },
                      { date: 'Yesterday', requests: 123, percentage: 40 },
                      { date: '2 days ago', requests: 89, percentage: 30 },
                      { date: '3 days ago', requests: 156, percentage: 50 },
                    ].map((day, index) => (
